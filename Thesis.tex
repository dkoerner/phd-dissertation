...
% enable to configure item lists
\usepackage{enumitem}
...
\usepackage{siunitx} % e-8 notation
\sisetup{output-exponent-marker=\ensuremath{\mathrm{e}}} % e-8 notation

% higher subs for Rec.709 notation
\usepackage[low-sup]{subdepth}

% Hyperref should be loaded last
\usepackage{hyperref} % hyperref creates clickable links in pdfs)

% remove page number from empty pages
% https://tex.stackexchange.com/questions/21629/avoiding-page-numbers-in-empty-pages
...
\setmuskip{\thinmuskip}{0mu}
%\setmuskip{\thickmuskip}{0mu}
...
\bibliographystyle{abbrvnatjan}
\bibliography{bibliography_cited}
...
%
\phantomsection
\include{08_appendices/appendix_derivation_rvalued_pn}
\include{08_appendices/diffusion_approximation_solver}
