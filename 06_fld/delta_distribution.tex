...
Consider an arbitrary vector $\vec{u}$. The construction of $T_{ij}=\vec{n}_i\vec{n}_j$ can be also expressed as the outer product between $\vec{n}$ with itsself. Transforming $\vec{u}$ with $T$ gives:
\begin{align}
