...
To improve the rate of convergence, we use successive over-relaxation (SOR) (see Hadjidimos~\cite{Hadjidimos00}). Defining the over-relaxation parameter $\omega$, where $0<\omega<2$, the update of $\phi_{ijk}$ at each stencil is modified to 
\begin{equation}
