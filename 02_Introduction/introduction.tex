...
\TD{With the increase in compute power came the viability of physical based methods. allowed better crosspollination with other fields}
...
\todo[inline]{How can SH based methods in other domains be applied to the problem of rendering in graphics? Is it viable?}

\TD{mention application in HPC as a motivation}

\section{Contributions and Outline}
\todo[inline]{Mention, that the real-valued PN equation is a contribution}

\TD{mention structure of the thesis: foundations and three main chapters with theory, intuition, solving, rendering application}
